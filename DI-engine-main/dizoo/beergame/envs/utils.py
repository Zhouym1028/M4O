...
test_arg.add_argument('--testInterval', type=int, default=100, help='every xx games compute "plot error"')
test_arg.add_argument(
...
test_arg.add_argument('--Ttest', type=int, default=100, help='it defines the number of periods in the plot cases')
test_arg.add_argument(
    '--ifOptimalSolExist',
    type=str2bool,
    default=True,
