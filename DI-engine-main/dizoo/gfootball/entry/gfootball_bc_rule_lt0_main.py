...
Overview:
    ...
    and (optional) plot accuracy in train dataset and plot dataset of the trained BC model
"""
...
if bc_config[0].policy.show_train_test_accuracy:
    """
    phase 3: plot accuracy in train dataset and plot dataset
    """
    ...
    # calculate accuracy in plot dataset
    print('==' * 10)
    print('calculate accuracy in plot dataset')
    print('==' * 10)
