...
# Note: origin gpu version of cover mode is not determinate, thus validation plot use origin cpu version instead
def scatter_val():
...
# Note: performance plot use origin gpu version
def scatter_perf():
    for scatter_type in ['add', 'cover']:
        ori_input = torch.randn(B, M, N)
        h = torch.randint(
...
if __name__ == '__main__':
    ...
    print("================run scatter validation plot================")
    scatter_val()
    print("================run scatter performance plot================")
    scatter_perf()
