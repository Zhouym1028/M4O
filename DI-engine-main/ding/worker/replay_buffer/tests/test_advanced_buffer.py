...
class TestAdvancedBuffer:
    ...
    def test_push(self):
        ...
        advanced_buffer = AdvancedReplayBuffer(buffer_cfg, tb_logger=None, instance_name='plot')
    ...
    def test_update(self):
        ...
        # plot case when data is None(such as max use remove)
    ...
    def test_rate_limit(self):
        ...
        prioritized_buffer = AdvancedReplayBuffer(buffer_cfg, tb_logger=None, instance_name='plot')
...
class TestDemonstrationBuffer:
    ...
    def test_naive(self, setup_demo_buffer_factory):
        ...
        while True:
            ...
            if len(data) != 0:
                break
            else:  # for the stability of dist-plot
                demo_data = {'data': generate_data_list(10)}
                with open(demo_data_path, "wb") as f:
                    pickle.dump(demo_data, f)
